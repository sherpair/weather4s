...
class EngineOpsCountriesSpec extends BaseSpec {
  ...
  "createIndexIfNotExists" when {
    "the \"countries\" index does not exist yet in the engine" should {
      "successfully load and decode the list of countries from a json resource" in new ImplicitsOpsIO {
        val countries = for {
    ...
    "the \"countries\" index does already exist in the engine" should {
      "successfully load and decode the list of countries from the engine" in new ImplicitsOpsIO {
        val countries = for {
          engineOps <- engineOpsF
    ...
    "the \"countries\" index does already exist in the engine" should {
      "throw an exception if it does not contain the expected data" in new ImplicitsOpsIO {
